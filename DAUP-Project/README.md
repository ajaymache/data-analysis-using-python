...
+ The dataset is cleaned and stored in a **CleanDataset** folder which contains the entire cleaned dataset named as [cleaned_autos.csv](https://github.com/ajaymache/DataAnalysisUsingPython/tree/master/DAUP-Project/CleanData) and another folder containing files structures containing subsets of the cleaned dataset based on brand of the vehicles and vehicle types.
##### Sample Dataset
